...
//        if(!q1.isPrime(number)){
//            System.out.printf("Your number %d is not prime number.",number);
//        }
//        else{
//            System.out.printf("Your number %d is prime number.",number);
//        }
//        Question2 q2= new Question2();
//        int nextNumber=q2.nextPrime(number);
//        System.out.printf("Next prime number is " + nextNumber);
